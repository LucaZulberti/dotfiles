# ------------------------------------------------------------------
# Prompt: dentro un multiplexer (tmux/zellij) uso l'indicatore
# custom; fuori uso il prompt standard di fish con un a capo prima
# della freccia, perché il pwd occupa spazio.
# ------------------------------------------------------------------
...
if set -q TMUX || set -q ZELLIJ
    ...
    # Fuori da un multiplexer: prompt standard di fish (identico al
    # default upstream), con un a capo prima del suffisso ">".
    function fish_prompt --description 'Write out the prompt'
        ...
        # A capo prima della freccia, per lasciare spazio al pwd.
        echo
